...
int normal_gpio_pwm_frequency(__attribute__((unused)) uint32_t pin, __attribute__((unused)) uint32_t freq) {
	errno = ENOTSUP;
	return -1;
}

int normal_gpio_pwm_write(__attribute__((unused)) uint32_t pin, __attribute__((unused)) uint16_t value) {
	errno = ENOTSUP;
	return -1;
}
...
int normal_gpio_analog_read(__attribute__((unused)) uint32_t pin, __attribute__((unused)) uint16_t* read) {
	errno = ENOTSUP;
	return -1;
}
