...
#define PIN_PWM3	MAKE_PIN_PCA9685(0x41, 0x09) //0x00004109
#define PIN_PWM2	MAKE_PIN_PCA9685(0x41, 0x0A) //0x0000410A
#define PIN_PWM1	MAKE_PIN_PCA9685(0x41, 0x0B) //0x0000410B
#define PIN_EXP1_RST    MAKE_PIN_PCA9685(0x40, 0x08) //0x00004008
#define PIN_EXP2_RST    MAKE_PIN_PCA9685(0x40, 0x0A) //0x0000400A
...
#define PIN_I0_1	MAKE_PIN_MCP23008(0x21, 0x02) //0x00002102
#define PIN_I0_2	MAKE_PIN_MCP23008(0x21, 0x04) //0x00002104
#define PIN_I0_3	MAKE_PIN_MCP23008(0x21, 0x01) //0x00002101
#define PIN_I0_4	MAKE_PIN_MCP23008(0x21, 0x03) //0x00002103
...
#define PIN_I0_8	MAKE_PIN_LTC2309(0x08, 0x05) //0x00000805
#define PIN_I0_9	MAKE_PIN_LTC2309(0x08, 0x07) //0x00000807
#define PIN_I0_10	MAKE_PIN_LTC2309(0x0A, 0x00) //0x00000A00
#define PIN_I0_11	MAKE_PIN_LTC2309(0x0A, 0x06) //0x00000A06
#define PIN_I0_12	MAKE_PIN_LTC2309(0x0A, 0x03) //0x00000A03
...
#define PIN_Q0_0	MAKE_PIN_PCA9685(0x41, 0x0C) //0x0000410C
#define PIN_Q0_1	MAKE_PIN_PCA9685(0x40, 0x00) //0x00004000
#define PIN_Q0_2	MAKE_PIN_PCA9685(0x41, 0x0F) //0x0000410F
#define PIN_Q0_3	MAKE_PIN_PCA9685(0x41, 0x0E) //0x0000410E
#define PIN_Q0_4	MAKE_PIN_PCA9685(0x41, 0x05) //0x00004105
#define PIN_Q0_5	MAKE_PIN_PCA9685(0x41, 0x04) //0x00004104
#define PIN_Q0_6	MAKE_PIN_PCA9685(0x41, 0x02) //0x00004102
#define PIN_Q0_7	MAKE_PIN_PCA9685(0x41, 0x00) //0x00004100
...
#define PIN_I0_3	MAKE_PIN_LTC2309(0x08, 0x05) //0x00000805
#define PIN_I0_4	MAKE_PIN_LTC2309(0x08, 0x07) //0x00000807
#define PIN_I0_5	MAKE_PIN_LTC2309(0x0A, 0x00) //0x00000A00
...
#define PIN_Q0_0	MAKE_PIN_PCA9685(0x41, 0x04) //0x00004104
#define PIN_Q0_1	MAKE_PIN_PCA9685(0x41, 0x02) //0x00004102
#define PIN_Q0_2	MAKE_PIN_PCA9685(0x41, 0x00) //0x00004100
...
#define PIN_R0_1	MAKE_PIN_MCP23008(0x21, 0x02) //0x00002102
#define PIN_R0_2	MAKE_PIN_MCP23008(0x21, 0x05) //0x00002105
#define PIN_R0_3	MAKE_PIN_MCP23008(0x21, 0x01) //0x00002101
#define PIN_R0_4	MAKE_PIN_MCP23008(0x21, 0x04) //0x00002104
#define PIN_R0_5	MAKE_PIN_PCA9685(0x41, 0x05) //0x00004105
#define PIN_R0_6	MAKE_PIN_PCA9685(0x41, 0x0E) //0x0000410E
#define PIN_R0_7	MAKE_PIN_PCA9685(0x41, 0x0F) //0x0000410F
#define PIN_R0_8	MAKE_PIN_PCA9685(0x40, 0x00) //0x00004000
...
#define PIN_I1_0	MAKE_PIN_MCP23008(0x20, 0x04) //0x00002004
#define PIN_I1_1	MAKE_PIN_MCP23008(0x20, 0x00) //0x00002000
#define PIN_I1_2	MAKE_PIN_MCP23008(0x20, 0x01) //0x00002001
#define PIN_I1_3	MAKE_PIN_MCP23008(0x21, 0x06) //0x00002106
#define PIN_I1_4	MAKE_PIN_MCP23008(0x21, 0x07) //0x00002107
#define PIN_I1_5	MAKE_PIN_DIRECT(27)
#define PIN_I1_6	MAKE_PIN_DIRECT(5)
#define PIN_I1_7	MAKE_PIN_LTC2309(0x28, 0x07) //0x00002807
#define PIN_I1_8	MAKE_PIN_LTC2309(0x08, 0x00) //0x00000800
#define PIN_I1_9	MAKE_PIN_LTC2309(0x28, 0x00) //0x00002800
#define PIN_I1_10	MAKE_PIN_LTC2309(0x0A, 0x02) //0x00000A02
#define PIN_I1_11	MAKE_PIN_LTC2309(0x08, 0x04) //0x00000804
#define PIN_I1_12	MAKE_PIN_LTC2309(0x0A, 0x04) //0x00000A04
...
#define PIN_Q1_1	MAKE_PIN_PCA9685(0x40, 0x06) //0x00004006
#define PIN_Q1_2	MAKE_PIN_PCA9685(0x40, 0x02) //0x00004002
#define PIN_Q1_3	MAKE_PIN_PCA9685(0x40, 0x05) //0x00004005
#define PIN_Q1_4	MAKE_PIN_PCA9685(0x41, 0x0D) //0x0000410D
#define PIN_Q1_5	MAKE_PIN_PCA9685(0x40, 0x01) //0x00004001
#define PIN_Q1_6	MAKE_PIN_PCA9685(0x41, 0x03) //0x00004103
#define PIN_Q1_7	MAKE_PIN_PCA9685(0x41, 0x01) //0x00004101
...
#define PIN_I1_2	MAKE_PIN_LTC2309(0x28, 0x07) //0x00002807
#define PIN_I1_3	MAKE_PIN_LTC2309(0x08, 0x00) //0x00000800
#define PIN_I1_4	MAKE_PIN_LTC2309(0x28, 0x00) //0x00002800
#define PIN_I1_5	MAKE_PIN_LTC2309(0x0A, 0x02) //0x00000A02
...
#define PIN_Q1_0	MAKE_PIN_PCA9685(0x40, 0x01) //0x00004001
#define PIN_Q1_1	MAKE_PIN_PCA9685(0x41, 0x03) //0x00004103
#define PIN_Q1_2	MAKE_PIN_PCA9685(0x41, 0x01) //0x00004101
...
#define PIN_R1_1	MAKE_PIN_MCP23008(0x20, 0x00) //0x00002000
#define PIN_R1_2	MAKE_PIN_MCP23008(0x20, 0x04) //0x00002004
#define PIN_R1_3	MAKE_PIN_MCP23008(0x21, 0x06) //0x00002106
#define PIN_R1_4	MAKE_PIN_MCP23008(0x20, 0x01) //0x00002001
#define PIN_R1_5	MAKE_PIN_PCA9685(0x41, 0x0D) //0x0000410D
#define PIN_R1_6	MAKE_PIN_PCA9685(0x40, 0x05) //0x00004005
#define PIN_R1_7	MAKE_PIN_PCA9685(0x40, 0x02) //0x00004002
#define PIN_R1_8	MAKE_PIN_PCA9685(0x40, 0x06) //0x00004006
...
#define PIN_I2_0	MAKE_PIN_MCP23008(0x20, 0x07) //0x00002007
#define PIN_I2_1	MAKE_PIN_MCP23008(0x20, 0x03) //0x00002003
#define PIN_I2_2	MAKE_PIN_MCP23008(0x20, 0x06) //0x00002006
#define PIN_I2_3	MAKE_PIN_MCP23008(0x20, 0x02) //0x00002002
#define PIN_I2_4	MAKE_PIN_MCP23008(0x20, 0x05) //0x00002005
#define PIN_I2_5	MAKE_PIN_DIRECT(26)
#define PIN_I2_6	MAKE_PIN_DIRECT(4)
#define PIN_I2_7	MAKE_PIN_LTC2309(0x08, 0x03) //0x00000803
#define PIN_I2_8	MAKE_PIN_LTC2309(0x28, 0x03) //0x00002803
#define PIN_I2_9	MAKE_PIN_LTC2309(0x08, 0x02) //0x00000802
#define PIN_I2_10	MAKE_PIN_LTC2309(0x08, 0x01) //0x00000801
#define PIN_I2_11	MAKE_PIN_LTC2309(0x28, 0x06) //0x00002806
#define PIN_I2_12	MAKE_PIN_LTC2309(0x0A, 0x01) //0x00000A01
...
#define PIN_Q2_0	MAKE_PIN_PCA9685(0x40, 0x0E) //0x0000400E
#define PIN_Q2_1	MAKE_PIN_PCA9685(0x40, 0x0C) //0x0000400C
#define PIN_Q2_2	MAKE_PIN_PCA9685(0x40, 0x0F) //0x0000400F
#define PIN_Q2_3	MAKE_PIN_PCA9685(0x40, 0x0D) //0x0000400D
#define PIN_Q2_4	MAKE_PIN_PCA9685(0x40, 0x07) //0x00004007
#define PIN_Q2_5	MAKE_PIN_PCA9685(0x40, 0x04) //0x00004004
#define PIN_Q2_6	MAKE_PIN_PCA9685(0x41, 0x07) //0x00004107
#define PIN_Q2_7	MAKE_PIN_PCA9685(0x41, 0x06) //0x00004106
...
#define PIN_I2_2	MAKE_PIN_LTC2309(0x08, 0x03) //0x00000803
#define PIN_I2_3	MAKE_PIN_LTC2309(0x28, 0x03) //0x00002803
#define PIN_I2_4	MAKE_PIN_LTC2309(0x08, 0x02) //0x00000802
#define PIN_I2_5	MAKE_PIN_LTC2309(0x08, 0x01) //0x00000801
...
#define PIN_Q2_0	MAKE_PIN_PCA9685(0x40, 0x04) //0x00004004
#define PIN_Q2_1	MAKE_PIN_PCA9685(0x41, 0x07) //0x00004107
#define PIN_Q2_2	MAKE_PIN_PCA9685(0x41, 0x06) //0x00004106
...
#define PIN_R2_1	MAKE_PIN_MCP23008(0x20, 0x03) //0x00002003
#define PIN_R2_2	MAKE_PIN_MCP23008(0x20, 0x07) //0x00002007
#define PIN_R2_3	MAKE_PIN_MCP23008(0x20, 0x02) //0x00002002
#define PIN_R2_4	MAKE_PIN_MCP23008(0x20, 0x06) //0x00002006
#define PIN_R2_5	MAKE_PIN_PCA9685(0x40, 0x07) //0x00004007
#define PIN_R2_6	MAKE_PIN_PCA9685(0x40, 0x0D) //0x0000400D
#define PIN_R2_7	MAKE_PIN_PCA9685(0x40, 0x0F) //0x0000400F
#define PIN_R2_8	MAKE_PIN_PCA9685(0x40, 0x0C) //0x0000400C
