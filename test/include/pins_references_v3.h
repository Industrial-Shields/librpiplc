...
#elif defined(RPIPLC_19R) || defined(RPIPLC_38R) || defined(RPIPLC_50RRA) || defined(RPIPLC_57R)
	{"I0.0", I0_0}, {"I0.1", I0_1}, {"I0.2", I0_2}, {"I0.3", I0_3}, {"I0.4", I0_4}, {"I0.5", I0_5},
#endif

#if defined(RPIPLC_42) || defined(RPIPLC_57AAR) || defined(RPIPLC_58)
	{"I1.0", I1_0}, {"I1.1", I1_1}, {"I1.2", I1_2}, {"I1.3", I1_3}, {"I1.4", I1_4}, {"I1.5", I1_5}, {"I1.6", I1_6},
#elif defined(RPIPLC_38R) || defined(RPIPLC_38AR) || defined(RPIPLC_50RRA) || defined(RPIPLC_53ARR) || defined(RPIPLC_54ARA) || defined(RPIPLC_57R)
	{"I1.0", I1_0}, {"I1.1", I1_1}, {"I1.2", I1_2}, {"I1.3", I1_3}, {"I1.4", I1_4}, {"I1.5", I1_5},
#endif
...
#elif defined(RPIPLC_53ARR) || defined(RPIPLC_57AAR) || defined(RPIPLC_57R)
	{"I2.0", I2_0}, {"I2.1", I2_1}, {"I2.2", I2_2}, {"I2.3", I2_3}, {"I2.4", I2_4}, {"I2.5", I2_5},
#endif
};
static const int numNamedDigitalInputs = sizeof(namedDigitalInputs) / sizeof(uint32_t);
...
#if defined(RPIPLC_50RRA) || defined(RPIPLC_54ARA) || defined(RPIPLC_58)
	{"I2.7", I2_7}, {"I2.8", I2_8}, {"I2.9", I2_9}, {"I2.10", I2_10}
...
static const int numNamedAnalogInputs = sizeof(namedAnalogInputs) / sizeof(uint32_t);
...
static const int numNamedDigitalOutputs = sizeof(namedDigitalOutputs) / sizeof(pin_name_t);
...
static const int numNamedAnalogOutputs = sizeof(namedAnalogOutputs) / sizeof(pin_name_t);
