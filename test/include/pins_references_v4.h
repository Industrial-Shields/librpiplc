...
static const int numNamedDigitalInputs = sizeof(namedDigitalInputs) / sizeof(pin_name_t);
...
static const int numNamedAnalogInputs = sizeof(namedAnalogInputs) / sizeof(pin_name_t);
